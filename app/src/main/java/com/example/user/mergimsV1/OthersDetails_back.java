...
public class OthersDetails_back extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_others_details_back);
        ...
        watertv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(OthersDetails_back.this, "NOT AVAILABLE NOW", Toast.LENGTH_SHORT).show();
                return;
